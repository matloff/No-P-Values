...
* Adding the interaction term changed the predictions--and the estimated
...
* Again, the above decision on whether to include interaction terms is
  ...
  supply our own power, devising a way to help us make a decision. 
...
* Instead, use the CI as intended:
  ...
  * Its center tells us our point estimate of the population quantity
    of interest.
