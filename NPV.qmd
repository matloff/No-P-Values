...
6. Such tools should not have binary yes/no output, which usurps the
   analyst's role and discards valuable information.  Instead, should be
   used to inform the analyst but not automatically make the decision,
   usurping the analyst.

7. This issue has been debated for years, notably among members of the
